...
imageContent.innerHTML = "The content of this page will be regularly updated with more <br><br> complex versions of existing visualisations and new projects. <br><br><br> The buttons below can be used to view visualisations independently. <br><br> Alternatively, complete data stories can be viewed using the nav bar.";
...
function show1() {
    cleanupContent();
    parentContainer.appendChild(imageContent);
    imageContent.innerHTML = '<img class="viz" src="viz/Story1Data1.jpg" alt="" style="mix-blend-mode: multiply;">';
    // move mix-blend-mode to css class viz
}
...
function show3(){
    cleanupContent();
    parentContainer.appendChild(imageContent);
    imageContent.innerHTML = '<img class="viz" src="viz/Story2Data2.jpg" alt="" style="mix-blend-mode: multiply;">';
}
